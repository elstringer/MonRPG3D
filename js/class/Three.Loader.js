THREE.Loader = function() {
		...
		this.getCompleted = function() {
				...
				if( !this.getMyCompleted() ) 
						...
						this.stateLoad = 'Chargement des images pour les ennemis '+stat(this.completedImage, this.noCompletedImage);
				else if( !this.getItemsCompleted() )
						this.stateLoad = 'Chargement des items '+stat(this.completedImage, this.noCompletedImage);
				else {
						this.setMapCurrent();
				...
				for( var keyMap in this.maps ) {
						...
						for( key in region.bots.list)
						{
								if(  typeof region.bots.list[key].img =='string' )
										region.bots.list[key].img = this.loadImage( dir_script+'images/character/'+region.bots.list[key].img );
		...
		this.setMapCurrent = function ( callback ) {
				console.log('region_'+ this.my.region);
