 ...
 class Statistiques_Model extends Model {
	 ...
	 public function general()
	 {
		 $sql = 'SELECT
							...
							( SELECT count(*) FROM map WHERE module_map = \'fight\' ) as nb_module_fight,
							...
							( SELECT count(*) FROM map WHERE module_map = \'shop\' ) as nb_module_shop,
							( SELECT count(*) FROM map WHERE module_map = \'sleep\' ) as nb_module_sleep';
