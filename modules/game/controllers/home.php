...
class Home_Controller extends Template_Controller {
		...
		public function index()
		{
				...
				$this->template->content->bottom = new View( 'user/inventaire' );
				$this->template->content->bottom->user = $this->user;
				$this->template->content->bottom->niveau_suivant = $this->user->niveau_suivant();
		}
